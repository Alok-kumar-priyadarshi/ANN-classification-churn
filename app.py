...
# one hot encode geography (use the selected value directly rather than treating it as a column name)
# geography is a string like 'France', not a column in input_data
